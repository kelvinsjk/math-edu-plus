...
function variablesToQn(
  variables: VariablesObjectB | VariablesObjectC,
): [VariablesObjectB | VariablesObjectC, QnContainer, AnswerContainer] {
  ...
  if (type === 2) {
    ...
    answers = {
      ...answers,
      ansB: binomPdf(1000, pY, y).toPrecision(3) + '.',
      ansC: binomCdfRange(1000, pY, y1, y2 - 1).toPrecision(3) + '.',
    };
  } else {
    // type === 3
    const x1 = 10 * p1 - 10;
    ...
    answers = {
      ...answers,
      ansB: binomCdfRange(1000, p1 / 100, x1, x2).toPrecision(3) + '.',
      ansC: binomCdfRange(1000, p2 / 10000, y1, y2 - 1).toPrecision(3) + '.',
    };
  }
