...
//} from 'math-edu';
import {
  Polynomial, RationalFunction, getRandomInt
...
function variablesToQn(type: number, restOfVariables: number[]): [variablesObject, string[], string[]] {
  ...
  const answers = type === 1 ?
    [transformation1Start, transformation1Axis, transformation2Start, transformation2Axis, transformation3Start, transformation3Axis] :
    [transformation3Start, transformation3Axis, transformation2Start, transformation2Axis, transformation1Start, transformation1Axis];
