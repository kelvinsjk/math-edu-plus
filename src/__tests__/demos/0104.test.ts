...
test('1204', () => {
  ...
  expect(a2[0]).toBe("\\pi \\left( \\frac{1}{2} \\mathrm{e}^{10} - \\frac{1}{2} \\mathrm{e}^{8} - 72 \\mathrm{e}^{5} + 54 \\mathrm{e}^{4} + 1647 \\right)");
  ...
  expect(a1[0]).toBe("\\pi \\left( \\frac{1}{2} \\mathrm{e}^{10} - \\frac{1}{2} \\mathrm{e}^{8} - 24 \\mathrm{e}^{5} + 18 \\mathrm{e}^{4} + 183 \\right)");
  ...
  for (let i = 0; i < 10; i++) {
    const { questions: [q], qnCode: qnCode } = qn0104();
    const { questions: [q2] } = qn0104({ qnCode: qnCode });
    expect(q).toBe(q2);
  }
