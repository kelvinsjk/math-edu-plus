...
const {
  ...
  answers: [a1a],
  qnCode: qc1,
} = qn0605({ qnCode: qCode1 });
const {
  questions: [q2A, q2B, q2C, q2D, q2E, q2F],
  answers: [a2a],
} = qn0605({ qnCode: 'aa8' });
const {
  questions: [q3A, q3B, q3C, q3D],
} = qn0605({ qnCode: 'ab3' });
const {
  questions: [q4A, q4B, q4C, q4D, q4E, q4F],
  answers: [a4a],
} = qn0605({ qnCode: 'ba7' });
const {
  questions: [q5A, q5B, q5C, q5D],
} = qn0605({ qnCode: 'bb7' });
...
test('0605', () => {
  expect(q1A).toBe(
    'x = \\cos^2 t, \\quad y = \\sin^3 t, \\quad \\textrm{for } 0 \\leq t \\leq {\\textstyle \\frac{\\pi}{2}}',
  );
  ...
  expect(qc1).toBe('aa3');
  expect(q2A).toBe(
    'x = \\cos^2 t, \\quad y = \\sin^8 t, \\quad \\textrm{for } 0 \\leq t \\leq {\\textstyle \\frac{\\pi}{2}}',
  );
  ...
  expect(q4A).toBe(
    'x = \\sin^2 t, \\quad y = \\cos^7 t, \\quad \\textrm{for } 0 \\leq t \\leq {\\textstyle \\frac{\\pi}{2}}',
  );
