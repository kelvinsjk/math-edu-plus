...
test('2202', () => {
  ...
  expect(q1.probabilityBulletTwo).toBe('the same as the probability of rain the previous day if it did not rain the previous day.');
  ...
  expect(q2.probabilityBulletOne).toBe('\\frac{1}{10} higher than the probability of rain the previous day if it rained the previous day,');
  expect(q2.probabilityBulletTwo).toBe('half the probability of rain the previous day if it did not rain the previous day.');
  ...
  expect(q3.probabilityBulletTwo).toBe('the probability that it does not rain, given that it did not rain the previous day, is 0.5.');
